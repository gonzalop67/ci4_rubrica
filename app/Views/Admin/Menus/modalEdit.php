<!-- Editar Menu Modal -->
<!-- Large modal -->
<div class="modal fade" id="editarMenuModal" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <form id="form_update" action="<?= base_url(route_to('menus_update')) ?>" autocomplete="off">
                <?= csrf_field(); ?>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" name="enlace" id="enlace" value="<?= $enlace ?>">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-select" id="publicado" name="publicado">
                            <option value="1" <?php if ($publicado == 1) echo "selected" ?>>Sí</option>
