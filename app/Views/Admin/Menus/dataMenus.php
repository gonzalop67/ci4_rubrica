...
?>
    <li class="dd-item dd3-item" data-id="<?php echo $menu->id_menu; ?>">
        ...
        <div class="dd3-content menu_link">
            <a href="<?php echo base_url(route_to('menus_edit', $menu->id_menu)); ?>"><?php echo "(" . $menu->pe_nombre . ") " . $menu->mnu_texto; ?></a>
            <div class="float-end">
            ...
            <ol class="dd-list">
                ...
                ?>
                    <li class="dd-item dd3-item" data-id="<?php echo $menu2->id_menu; ?>">
                        <div class="dd-handle dd3-handle"></div>
                        <div class="dd3-content menu_link">
                            <a href="<?php echo base_url(route_to('menus_edit', $menu2->id_menu)); ?>"><?php echo $menu2->mnu_texto; ?></a>
                            <div class="float-end">
