...
<?= $this->section('title') ?>
Asociar Paralelos con Inspectores
...
<div class="container-fluid px-4">
    ...
    <div class="card mt-2">
        ...
        <div class="card-body">
            <form id="form_insert" action="<?= base_url(route_to('paralelos_inspectores_store')) ?>" method="post">
                <div class="mb-2 row">
        ...
        <div class="card-footer">
            <div class="row">
                <div class="col-10 text-end">
                    <label class="control-label" style="position:relative; top:7px;">Total Inspectores:</label>
                </div>
                <div class="col-2" style="margin-top: 2px;">
                    <input type="text" class="form-control" id="total_inspectores" value="0" disabled>
                </div>
            </div>
        </div>
    </div>
...
<script>
    ...
    function listarInspectoresAsociados() {
        $('#id_paralelo').removeClass('is-invalid');
        $('.error-id-paralelo').html('');
        ...
        var request = $.ajax({
            url: "<?= base_url(route_to('paralelos_inspectores_data')) ?>",
            method: "post",
            dataType: "json"
        });
        ...
        request.done(function(data) {
            ...
            if (data.length > 0) {
                ...
                $("#lista_items").html("<tr><td colspan='4' align='center'>No se han asociado inspectores a este periodo lectivo...</td></tr>");
