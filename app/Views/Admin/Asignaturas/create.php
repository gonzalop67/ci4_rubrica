...
<div class="container-fluid px-4">
    <ol class="breadcrumb mb-4">
        <li class="breadcrumb-item active">Crear una nueva Asignatura</li>
    </ol>
    ...
    <div class="card mb-4">
        ...
        <div class="card-body">
            <form action="<?= base_url(route_to('asignaturas_store')) ?>" method="post">
                <div class="mb-3">
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="id_area" name="id_area">
                        ...
                        ?>
                            <option value="<?= $area->id_area ?>"><?= $area->ar_nombre ?></option>
                        <?php endforeach ?>
                    </select>
                ...
                <div class="mb-3">
                    ...
                    <select class="form-select" id="id_tipo_asignatura" name="id_tipo_asignatura">
                        ...
                        ?>
                            <option value="<?= $tipo_asignatura->id_tipo_asignatura ?>"><?= $tipo_asignatura->ta_descripcion ?></option>
                        <?php endforeach ?>
                    </select>
