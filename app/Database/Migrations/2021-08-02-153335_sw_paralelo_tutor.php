...
class SwParaleloTutor extends Migration
{
	public function up()
	{
		$this->forge->addField([
		...
		$this->forge->addKey('id_paralelo_tutor', true);
		...
		$this->forge->createTable('sw_paralelo_tutor');
	}
	...
	{
		$this->forge->dropTable('sw_paralelo_tutor');
	}
}
