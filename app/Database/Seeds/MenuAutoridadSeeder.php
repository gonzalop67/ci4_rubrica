...
class MenuAutoridadSeeder extends Seeder
{
	...
	{	
        ...
        $menus = [
			[
				'mnu_texto'     => 'Definiciones', // id_menu = 28
                'mnu_link'      => '#',
                'mnu_nivel'     => 1,
                'mnu_orden'     => 1,
                'mnu_padre'     => 0,
            ...
            [
				'mnu_texto'     => 'Consultas', // id_menu = 31
                'mnu_link'      => '#',
                'mnu_nivel'     => 1,
                'mnu_orden'     => 4,
                'mnu_padre'     => 0,
            ...
            [
				'mnu_texto'     => 'Estadísticas', // id_menu = 32
                'mnu_link'      => '#',
                'mnu_nivel'     => 1,
                'mnu_orden'     => 5,
                'mnu_padre'     => 0,
			...
			[
				'mnu_texto'     => 'Malla Curricular', // id_menu = 33
			...
			[
				'mnu_texto'     => 'Distributivo', // id_menu = 34
			...
			[
				'mnu_texto'     => 'Definir Días de la Semana', // id_menu = 35
			...
			[
				'mnu_texto'     => 'Definir Horas Clase', // id_menu = 36
            ...
            [
				'mnu_texto'     => 'Asociar Dia-Hora', // id_menu = 37
			...
			[
				'mnu_texto'     => 'Definir Horario Semanal', // id_menu = 38
			...
			[
				'mnu_texto'     => 'Definir Inasistencias', // id_menu = 39
			...
			[
				'mnu_texto'     => 'Parciales', // id_menu = 40
			...
			[
				'mnu_texto'     => 'Quimestrales', // id_menu = 41
			...
			[
				'mnu_texto'     => 'Lista de docentes', // id_menu = 43
            ...
            [
				'mnu_texto'     => 'Horarios de clase', // id_menu = 44
			...
			[
				'mnu_texto'     => 'Aprobados por Paralelo', // id_menu = 45
