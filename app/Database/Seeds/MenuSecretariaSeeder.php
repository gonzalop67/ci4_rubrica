...
class MenuSecretariaSeeder extends Seeder
{
	...
	{	
        ...
        $menus = [
            [
				'mnu_texto'     => 'Matriculación', // id_menu = 46
                'mnu_link'      => '#',
                'mnu_nivel'     => 1,
                'mnu_orden'     => 1,
                'mnu_padre'     => 0,
			...
			[
				'mnu_texto'     => 'Nómina de Matriculados', // id_menu = 52
			...
			[
				'mnu_texto'     => 'Por Asignatura', // id_menu = 53
			...
			[
				'mnu_texto'     => 'Parciales', // id_menu = 54
            ...
            [
				'mnu_texto'     => 'Quimestral', // id_menu = 55
			...
			[
				'mnu_texto'     => 'De Supletorios', // id_menu = 57
			...
			[
				'mnu_texto'     => 'Padrón Electoral', // id_menu = 58
			...
			[
				'mnu_texto'     => 'Cuadro Final', // id_menu = 59
